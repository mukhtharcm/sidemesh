...
Full-app UX audit completed 2026-05. Each file contains a prioritised
issue, the exact user impact, affected files, and a step-by-step
implementation plan.
...
- **P0** — Actively blocks or confuses first-time and daily users; fix immediately.
