...
class TerminalModifierState {
  ...
  TerminalModifierState toggleCtrl() => copyWith(ctrl: !ctrl);

  TerminalModifierState toggleAlt() => copyWith(alt: !alt);

  TerminalModifierState toggleShift() => copyWith(shift: !shift);

  TerminalModifierState cleared() => const TerminalModifierState();
