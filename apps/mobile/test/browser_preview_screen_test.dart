...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await tester.tap(find.byIcon(AppIcons.construction_outlined));
      await _pumpFrames(tester);
      ...
      await tester.tap(find.byIcon(AppIcons.delete_outline_rounded));
      await _pumpFrames(tester);
  ...
  testWidgets('browser preview renders a live network tab and detail sheet', (
    ...
    await tester.tap(find.byIcon(AppIcons.copy_all_rounded));
    await _pumpFrames(tester);
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await tester.tap(find.byIcon(AppIcons.pause_circle_outline_rounded));
      await _pumpFrames(tester);
      await tester.tap(find.text('main.js'));
      await _pumpFrames(tester);
