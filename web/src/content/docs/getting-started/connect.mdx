...
That manual background mode is enough for pairing. If you want the app's
restart and update actions to bring the host back automatically, prefer an OS
service on macOS or Linux:
