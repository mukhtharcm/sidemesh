...
This works best when Sidemesh is installed as a background service on macOS or
Linux.

If you started the daemon with `sidemesh daemon` or `sidemesh start`, start it
