...
It also includes a lightweight remote DevTools surface inside the client for browser storage, network traffic, and console output.
...
- Built-in DevTools are lighter than full Chrome DevTools and do not yet include a DOM/CSS inspector
